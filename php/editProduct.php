<?php
    ...
    if($conn->connect_error){
        ...
        $sql = "UPDATE products SET productName='$productName',price='$price',shippingPrice='$shippingPrice',discount='$discount',stock='$stock',categoryID='$categoryID',description='$description',extraDetails='$extraDetails' WHERE productID='$productID'";
